      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          <a href="#">
            ...
            <span>Checker Cartão</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="chartjs.html"><i class="fa fa-circle-o"></i> Checker Geradas</a></li>
...
<!-- || =================================================================================== || -->
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../_pagseguro/pagseguro.php"><i class="fa fa-circle-o"></i> PagSeguro</a></li>
            <li><a href="../_bcash/bcash.php"><i class="fa fa-circle-o"></i> Bcash</a></li>
            <li><a href="../_casasbahia/casasbahias.php"><i class="fa fa-circle-o"></i> CasasBahia</a></li>
            <li><a href="../_colombo/colombo.php"><i class="fa fa-circle-o"></i> Colombo</a></li>
            <li><a href="../_extra/extra.php"><i class="fa fa-circle-o"></i> Extra</a></li>
            <li><a href="../_moip/moip.php"><i class="fa fa-circle-o"></i> Moip</a></li>
          </ul>
        </li>
        <!-- Fim testador login -->
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Testadores de Login</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="_spotfy/spotify.php"><i class="fa fa-circle-o"></i> Spotify</a></li>
            <li><a href="_bol/bol.php"><i class="fa fa-circle-o"></i> Bol</a></li>
            <li><a href="_ddtank/ddtank"><i class="fa fa-circle-o"></i> DDTank</a></li>
            <li><a href="_netflix/netflix"><i class="fa fa-circle-o"></i> Netflix</a></li>
          </ul>
        </li>
        <!--|| ======================================================================================= || -->
       ...
       <div class="panel">
               ...
               <div class="panel-body">
                    <div class="col-xs-8 col-sm-12">
                        <textarea name="lista" id="lista" onkeyup="contar_total(this);" placeholder="xxxxxxxxxxxxxxxx|xx|xxxx|xxx" style="height: 150px; width: 100%; "  rows="7"></textarea>
                    </div>
