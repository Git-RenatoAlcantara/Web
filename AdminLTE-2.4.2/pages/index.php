...
<head>
  ...
  <title>Sh4dow-D3v | Dashboard</title>
...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p style="font-size: 23px;"><?php echo $user ?></p>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="_magazine/magazine.php"><i style="color: green;" class="fa fa-circle-o"></i>Magazine</a></li>
          </ul>
        </li>
        <!-- Fim testador login -->
  ...
  <div class="content-wrapper" style="background-image: url(../img/background-login.png);">

<!-- INICIO CONTADOR -->
<div style="text-align: center;">
<a href='http://www.blogutils.net/olct/' id='lnolt_' target='_blank' style='text-decoration:none;'>
<script language='JavaScript' src='http://blogutils.net/olct/online.php?site=http://sh4dowd3v-checker.epizy.c&interval=600'></script></a><a href='http://www.blogutils.net/' target='_blank' style='text-decoration:none;'> online</a>
<!-- FIM CONTADOR -->
</div>
    <!-- Main content -->
<!-- ./wrapper -->
...
(function(){ var widget_id = 'XpBhVRblkD';var d=document;var w=window;function l(){
var s = document.createElement('script'); s.type = 'text/javascript'; s.async = true; s.src = '//code.jivosite.com/script/widget/'+widget_id; var ss = document.getElementsByTagName('script')[0]; ss.parentNode.insertBefore(s, ss);}if(d.readyState=='complete'){l();}else{if(w.attachEvent){w.attachEvent('onload',l);}else{w.addEventListener('load',l,false);}}})();</script>
<!-- {/literal} END JIVOSITE CODE -->
<center>
<h3><strong><font color="#71BA51">Discord: Old-School#3748</font></strong></h3> 
</center>
<!-- jQuery 3 -->
